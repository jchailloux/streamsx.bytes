...
sub main::generate($$) {
   ...
   print '}', "\n";
   print "\n";
   print 'void readMessageDef(json_t *element){', "\n";
   ...
   print '	}', "\n";
   print '//    readPacketLevel(message,packet);', "\n";
   print '    object.messages.push_back(message);', "\n";
   print '	SPLAPPTRC(L_TRACE, "<-readMessageDef", SPL_OPER_DBG);', "\n";
   print '}', "\n";
   print 'void readDictionnaryDef(json_t *element){', "\n";
   ...
   print '        }', "\n";
   print '        object.dictionnary[k.c_str()[0]]=v;', "\n";
   print '    }', "\n";
   print '	SPLAPPTRC(L_TRACE, "<-readDictionnaryDef", SPL_OPER_DBG);', "\n";
   print '}', "\n";
   print "\n";
   print 'void readObjectDef(json_t *element){', "\n";
   ...
   print '        	readObjectDef(value);', "\n";
   print '        }', "\n";
   print '        if(strcmp(key,"name") ==0){', "\n";
   print '        	object.name = json_string_value(value);', "\n";
   print "\n";
   print '        }', "\n";
   ...
   print '        	size_t size = json_array_size(value);', "\n";
   print '	        for (size_t i = 0; i < size; i++) {', "\n";
   print '	        	readMessageDef(json_array_get(value, i));', "\n";
   print '			}', "\n";
   print '        }', "\n";
   ...
   print '        	size_t size = json_array_size(value);', "\n";
   print '	        for (size_t i = 0; i < size; i++) {', "\n";
   print '	        	readDictionnaryDef(json_array_get(value, i));', "\n";
   print '			}', "\n";
   print '        }', "\n";
   print '	}', "\n";
   print '	SPLAPPTRC(L_TRACE, "<-readObjectDef", SPL_OPER_DBG);', "\n";
   ...
   print '}', "\n";
   print 'void printDictionnaryDef(){', "\n";
   print '	SPLAPPTRC(L_DEBUG,  "--------Dictionnary-------- ", SPL_OPER_DBG);', "\n";
   print '    for ( std::map< char, string, std::less< int > >::const_iterator iter = object.dictionnary.begin();iter != object.dictionnary.end(); ++iter )', "\n";
   ...
   print "\n";
   print '}', "\n";
   print 'void printObjectDef(){', "\n";
   print '	SPLAPPTRC(L_DEBUG,  "Object : " << object.name, SPL_OPER_DBG);', "\n";
   print '	SPLAPPTRC(L_DEBUG, "Number of messages : " << object.messages.size(), SPL_OPER_DBG);', "\n";
   print '	for(unsigned int i=0; i < object.messages.size(); i++){', "\n";
   print '		printMessageDef( object.messages[i],"\\t");', "\n";
   print '	}', "\n";
   print '	printDictionnaryDef();', "\n";
   print '}', "\n";
   print 'void loadExtractorSchema(string fileName){', "\n";
   ...
   print '						 */', "\n";
   print '						boost::dynamic_bitset<> extracted;', "\n";
   print '					    extracted=(binary>>(binary.size()-(object.messages[messageCounter].multiplex[multiplexCounter].parameters[parameterCounter].start+object.messages[messageCounter].multiplex[multiplexCounter].parameters[parameterCounter].length)));', "\n";
   ...
   print '							reverseBinary(extracted);', "\n";
   print '						}', "\n";
   print '						SPLAPPTRC(L_DEBUG,"Extracted : "<< extracted<< " , "<< extracted.to_ulong(), SPL_OPER_DBG);', "\n";
